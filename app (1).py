...
def get_model():
    ...
    for name in ["gemini-3.6-flash", "gemini-2.5-flash", "gemini-flash-latest", "gemini-2.0-flash", "gemini-1.5-flash"]:
        try:
...
with left:
    ...
    st.iframe(POWER_BI_EMBED_URL, height=700, scrolling=True)
